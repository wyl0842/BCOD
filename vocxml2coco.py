...
# category_set = dict()
category_set = {'aeroplane': 0, 'bicycle': 1, 'bird': 2, 'boat': 3, 'bottle': 4, 'bus': 5, 'car': 6, 'cat': 7, 'chair': 8, 'cow': 9, 'diningtable': 10, 'dog': 11, 'horse': 12, 'motorbike': 13, 'person': 14, 'pottedplant': 15, 'sheep': 16, 'sofa': 17, 'train': 18, 'tvmonitor': 19}
image_set = set()
...
def parseXmlFiles_by_txt(data_dir, json_save_path, split='train'):
    ...
    for cate, cid in category_set.items():
...
if __name__ == '__main__':
    # 通过txt文件生成
    voc_data_dir="/home/wangyl/Code/mmdetection/data/VOCdevkit/VOCdevkit/VOC2007"
    json_save_path="/home/wangyl/Code/mmdetection/data/voc2007val.json"
