...
class MTAlignHead(ATSSHead):
    ...
    def __init__(self,
        ...
        if self.train_cfg:
            ...
            self.final_epoch = self.train_cfg['final_epoch']
            ...
            self.alignment_assigner_final = TASK_UTILS.build(
                self.train_cfg['final_assigner'])
    ...
    def get_targets(self,
        ...
        # 采用dynamicsoft的正样本分配策略，利用预测的cls和bbox分配正负样本
        # all_assign_metrics为[17950]*4(batch)，正样本位置有tood分数其余为0
        elif self.epoch < self.final_epoch:
            (all_anchors, all_labels, all_label_weights, all_bbox_targets,
        ...
        # all_assign_metrics为[17950]*4(batch)，正样本位置有tood分数其余为0
            ...
            self.alignment_assigner = self.alignment_assigner_final
            (all_anchors, all_labels, all_label_weights, all_bbox_targets,
             all_assign_metrics) = multi_apply(
                 self._get_targets_single,
                 cls_scores,
