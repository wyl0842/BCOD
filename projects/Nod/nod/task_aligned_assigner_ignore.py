...
class TaskAlignedAssignerIgnore(BaseAssigner):
    ...
    def assign(self,
        ...
        if (self.ignore_iof_thr > 0 and gt_bboxes_ignore is not None
            ...
            assigned_gt_inds[ignore_idxs] = -5
