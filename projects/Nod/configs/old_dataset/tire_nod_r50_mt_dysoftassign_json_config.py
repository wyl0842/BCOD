...
_base_ = [
    'tire_base_7class.py', 'nod_r50.py'
]
...
detector.bbox_head = dict(
    ...
    num_dcn=2)
detector.train_cfg.assigner = dict(type='DynamicSoftLabelAssigner', topk=13)
...
work_dir = './outputs/new_dataset/tire_nod_mtdysoftassign_r50'
seed = 10086