...
_base_ = [
    'voc2coco_base_cls0.4_box0.2.py', '../../nod_r50.py'
]
...
detector.train_cfg = dict(
        ...
        assigner=dict(type='TaskAlignedAssignerIgnore', topk=13),
...
model = dict(
    ...
    semi_train_cfg=dict(
        ...
        lc_assigner = dict(
            ...
            match_costs=[
                dict(type='ClassificationCost', weight=1.),# 1.,5.
                dict(type='BBoxL1Cost', weight=1.0, box_format='xywh'),
                dict(type='IoUCost', iou_mode='giou', weight=2.0)#2.0,5.0
            ])),
...
work_dir = './outputs/voc_dataset/voc_cls0.4_box0.2_savecorrection/correct_nod_mtcorrection_r50_warmup1_smooth0.7_setepoch_tau0.8_epoch12'
seed = 10086