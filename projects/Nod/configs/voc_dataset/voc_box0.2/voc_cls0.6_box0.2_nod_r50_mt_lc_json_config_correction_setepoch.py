...
_base_ = [
    'voc2coco_base_cls0.6_box0.2.py', '../../nod_r50.py'
]
...
work_dir = './outputs/voc_dataset/voc_cls0.6_box0.2/nod_mtcorrection_r50_warmup1_smooth0.7_setepoch_tau0.8_epoch12'
seed = 10086