...
_base_ = [
    'tire_0.3_base_7class_semi_aug.py', '../nod_r50.py'
]
...
work_dir = './outputs/new_dataset_0.3/savecorrection_tire_nod_mtcorrection_r50_setepoch_smooth0.4_tau0.8'
seed = 10086