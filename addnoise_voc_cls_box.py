...
def main():
    ...
    modified_annotations = add_noise_to_coco_annotations(modified_annotations, class_mapping, cls_proportion=0.6, box_proportion=0)

    # 保存修改后的标签到新的JSON文件
    with open('/home/wangyl/Code/mmdetection/data/voc2007trainval_cls0.6_box0.json', 'w') as f:
