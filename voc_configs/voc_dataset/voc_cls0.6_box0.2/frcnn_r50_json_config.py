# python tools/train.py my_configs/comparison/tyre_frcnn_r50_json_config.py
_base_ = [
    'voc2coco_base_cls0.6_box_0.2.py'
]
...
work_dir = './outputs/voc_dataset/voc_cls0.6_box0.2/frcnn_r50'
seed = 10086